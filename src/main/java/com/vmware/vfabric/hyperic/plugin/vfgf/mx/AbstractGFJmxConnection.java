...
public abstract class AbstractGFJmxConnection {
        ...
        try {
            ...
            adminDistributedSystemMBean = 
                (ObjectName) mServer.invoke(gemFireAgentMBean,
                        ...
                        GFMXUtils.EMPTY_DEF);
            log.debug("[connectToSystem] Found distributed system: " + adminDistributedSystemMBean);
            return adminDistributedSystemMBean;
        } catch (Exception e) {
            log.debug("[connectToSystem] Error to connect jmx agent to system: " + e.getMessage(), e);
        }
        return null;
    }
    ...
    protected ObjectName[] manageCacheServers(){
        ...
        try {
            ...
            log.debug("[manageCacheServers] Error requesting cache servers: " + e.getMessage(), e);
        }
        return null;
    }
    ...
    protected ObjectName[] manageCacheVMStats(String id){
        ...
        try {
            ...
            log.debug("[manageCacheVMStats] Error requesting statistics mbeans: " + e.getMessage(), e);
        }
        return null;
    }
    ...
    protected ObjectName[] manageApplicationStats(String id){
        ...
        try {
            ...
            log.debug("[manageApplicationStats] Error requesting statistics mbeans: " + e.getMessage(), e);
        }
        return null;
    }
    ...
    protected ObjectName[] manageCaches() {
        ...
        try {
            ...
            log.debug("[manageCaches] " + e.getMessage(), e);
        }
    ...
    public ObjectName manageCache(ObjectName cacheVm) {
        try {
            ...
            log.debug("[manageCache] " + e.getMessage(), e);
        }
    ...
    public ObjectName[] manageRegions(ObjectName cache) {
        ...
        try {
            ...
            for (String s : rootRegions) {
                log.debug("[manageRegions] Found root region: " + s);
                ObjectName region = 
            ...
            log.debug("[manageRegions] " + e.getMessage(), e);
        }
    ...
    public void manageSubRegions(ObjectName region, ObjectName cache, ArrayList<ObjectName> regions) {
        try {
            ...
            for (String s : subRegions) {
                log.debug("[manageSubRegions] Found sub region: " + s);
            ...
            log.debug("[manageSubRegions] " + e.getMessage(), e);
        }
    }
    ...
    protected Map<String, Double>getStats(MemberInfo member, String name) {
        ...
        try {
            ...
            log.debug("[getStats] " + e.getMessage(), e);
        }
    ...
    protected Map<String, Double>getStats(MemberInfo member, String name, String[] keys) {
        ...
        try {
            ...
            log.info("[getStats] Unable to collect stats." + e.getMessage());
            log.debug("[getStats] " + e.getMessage(), e);
        }
    ...
    protected boolean refreshStatistics(ObjectName statMBean){
        try {
            ...
            log.debug("[refreshStatistics] Error updating stats for mbean:" + statMBean, e);
        }
        return false;
    }
    ...
    protected ObjectName getCacheServerObject(String gfid) {
        ...
        try {
            ...
            log.debug("[getCacheServerObject] " + e.getMessage(), e);
        }
        return bean;
    }
    ...
    protected ObjectName getApplicationObject(String gfid) {
        ...
        try {
            ...
            log.debug("[getApplicationObject] " + e.getMessage(), e);
        }
        return bean;
    }
    ...
    protected String getAgentVersionString() {
        ...
        try {
            ...
            log.debug("[getAgentVersionString] Can't use given jmx url", mue);
        } catch (Exception e) {
            log.debug("[getAgentVersionString] General error talking to jmx agent", e);
        }
        return version;
    }
